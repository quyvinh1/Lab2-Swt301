 ...
 * @author admin
 */
@WebServlet(name = "ChangeAvatarControl", urlPatterns = {"/ChangeAvatarControl"})
@MultipartConfig(maxFileSize = 16177216)//1.5mb
public class ChangeAvatarControl extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ChangeAvatarControl</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ChangeAvatarControl at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
